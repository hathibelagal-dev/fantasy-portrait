...
class WanT2VCrossAttention(WanSelfAttention):
    ...
    def forward(self, x, context, context_lens, adapter_proj, ip_scale: float = 1.0, **kwargs):
        """
        x:              [B, L1, C].
        context:        [B, L2, C].
        context_lens:   [B].
        ...
        if adapter_proj is None:
            ...
            return self.processor(self, x, context, context_lens, adapter_proj, ip_scale)
...
class WanI2VCrossAttention(WanSelfAttention):
    ...
    def forward(self, x, context, context_lens, adapter_proj, adapter_context_lens, latents_num_frames, ip_scale: float = 1.0, adapter_attn_mask=None, **kwargs):
        """
        x:              [B, L1, C].
        context:        [B, L2, C].
        context_lens:   [B].
        ...
        if adapter_proj is None:
            ...
            return self.processor(self, x, context, context_lens, adapter_proj, adapter_context_lens, latents_num_frames, ip_scale, adapter_attn_mask)
        # return self.processor(self, x, context, context_lens)
